...
#                   url(r'^viewtreandingtopics/(?P<chart_type>\w+)/$', admin_view.viewtreandingtopics,
#                       name="viewtreandingtopics"),
#                   url(r'^negativefeedbacktivechart/(?P<chart_type>\w+)/$', admin_view.negativefeedbacktivechart,
...
urlpatterns = [
  ...
  path("research/",include("Research.urls","Research"))
]
